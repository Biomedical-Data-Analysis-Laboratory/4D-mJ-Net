...
def van_De_Leemput(params):
    ...
    conv_15 = layers.Conv3D(len(get_labels()), (1, 1, getNUMBER_OF_IMAGE_PER_SECTION()), activation="softmax", padding='same', strides=(1, 1,
    ...
    y = layers.Reshape((get_m(), get_n(), len(get_labels())))(conv_15)
