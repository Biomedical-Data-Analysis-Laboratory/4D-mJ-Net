...
def VNet_Milletari(params, to_categ):
    ...
    # Stage 1
    stage_1 = layers.Conv3D(16, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(input_x)
    ...
    conv_1 = layers.Conv3D(32, kernel_size=(2,2,2), activation=None, padding='same', strides=(2,2,2),
                           kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_1)
    conv_1 = layers.PReLU()(conv_1)
    stage_2 = layers.Conv3D(32, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(conv_1)
    stage_2 = layers.PReLU()(stage_2)
    stage_2 = layers.Conv3D(32, kernel_size=kernel_size, activation=None, padding='same', kernel_initializer=kernel_init,
    ...
    conv_2 = layers.Conv3D(64, kernel_size=(2,2,2), activation=None, padding='same', strides=(2,2,3),
                           kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_2)
    conv_2 = layers.PReLU()(conv_2)

    # Stage 3
    stage_3 = layers.Conv3D(64, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(conv_2)
    stage_3 = layers.PReLU()(stage_3)
    stage_3 = layers.Conv3D(64, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_3)
    stage_3 = layers.PReLU()(stage_3)
    stage_3 = layers.Conv3D(64, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_3)
    stage_3 = layers.PReLU()(stage_3)
    ...
    conv_3 = layers.Conv3D(128, kernel_size=kernel_size, activation=None, padding='same', strides=(2,2,5),
                           kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_3)
    conv_3 = layers.PReLU()(conv_3)

    # Stage 4
    stage_4 = layers.Conv3D(128, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(conv_3)
    stage_4 = layers.PReLU()(stage_4)
    stage_4 = layers.Conv3D(128, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_4)
    stage_4 = layers.PReLU()(stage_4)
    stage_4 = layers.Conv3D(128, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_4)
    stage_4 = layers.PReLU()(stage_4)
    ...
    conv_4 = layers.Conv3D(256, kernel_size=kernel_size, activation=None, padding='same', strides=(2,2,1),
                           kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_4)
    conv_4 = layers.PReLU()(conv_4)
    general_utils.print_int_shape(conv_4)  # (None, M/16, N/16, 1, 128)

    # Stage 5
    stage_5 = layers.Conv3D(256, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(conv_4)
    stage_5 = layers.PReLU()(stage_5)
    stage_5 = layers.Conv3D(256, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_5)
    stage_5 = layers.PReLU()(stage_5)
    stage_5 = layers.Conv3D(256, kernel_size=kernel_size, activation=None, padding='same',
                            kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_5)
    stage_5 = layers.PReLU()(stage_5)
    ...
    conv_5 = layers.Conv3DTranspose(256, kernel_size=kernel_size, activation=None, padding='same', strides=(2,2,1),
                                    kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(stage_5)
    conv_5 = layers.PReLU()(conv_5)

    # R-Stage 4
    # fine-grained feature forwarding (== concatenation according to the U-Net paper
    r_stage_4 = layers.concatenate([stage_4, conv_5])
    r_stage_4 = layers.Conv3D(256, kernel_size=kernel_size, activation=None, padding='same',
                              kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_4)
    ...
    conv_6 = layers.Conv3DTranspose(128, kernel_size=kernel_size, activation=None, padding='same', strides=(2,2,5),
                                    kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_4)
    conv_6 = layers.PReLU()(conv_6)

    # R-Stage 3
    r_stage_3 = layers.concatenate([stage_3, conv_6])
    r_stage_3 = layers.Conv3D(128, kernel_size=kernel_size, activation=None, padding='same',
                              kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_3)
    ...
    conv_7 = layers.Conv3DTranspose(64, kernel_size=kernel_size, activation=None, padding='same', strides=(2,2,3),
                                    kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_3)
    conv_7 = layers.PReLU()(conv_7)

    # R-Stage 2
    r_stage_2 = layers.concatenate([stage_2, conv_7])
    r_stage_2 = layers.Conv3D(64, kernel_size=kernel_size, activation=None, padding='same',
                              kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_2)
    ...
    conv_8 = layers.Conv3DTranspose(32, kernel_size=kernel_size, activation=None, padding='same', strides=(2,2,2),
                                    kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_2)
    conv_8 = layers.PReLU()(conv_8)

    # R-Stage 1
    r_stage_1 = layers.concatenate([stage_1, conv_8])
    r_stage_1 = layers.Conv3D(32, kernel_size=kernel_size, activation=None, padding='same',
                              kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_1)
    ...
    last_conv = layers.Conv3D(2, kernel_size=kernel_size, activation=None, padding='same',
                              kernel_initializer=kernel_init, kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(r_stage_1)
    ...
    last_conv = layers.Conv3D(last_channels, kernel_size=(5,5,constants.NUMBER_OF_IMAGE_PER_SECTION),
...
def VNet_Light(params, to_categ):
    ...
    last_conv = InstanceNormalization()(last_conv)
...
def ThreeD_Light_Module(layer_in, Cin, Cout, g, kernel_init, kernel_constraint, bias_constraint):
    ...
    for ig in range(g):
        ...
        two_par = layers.Conv3D(int(Cin/g), kernel_size=(1,1,1), activation="relu", padding='same', kernel_initializer=kernel_init,
                                kernel_constraint=kernel_constraint, bias_constraint=bias_constraint)(one)
        two_par = InstanceNormalization()(two_par)
