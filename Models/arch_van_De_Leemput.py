...
def van_De_Leemput(X, params, to_categ):
    ...
    general_utils.print_int_shape(conv_1) # (None, 30, 16, 16, 32)
    ...
    general_utils.print_int_shape(conv_2) # (None, 30, 16, 16, 64)
    add_1 = layers.add([input_x, conv_2])
    general_utils.print_int_shape(add_1)  # (None, 30, 16, 16, 64)

    pool_1 = layers.MaxPooling3D((3,2,2))(add_1)
    general_utils.print_int_shape(pool_1) # (None, 10, 8, 8, 64)
    ...
    general_utils.print_int_shape(conv_3) # (None, 10, 8, 8, 64)
    ...
    general_utils.print_int_shape(conv_4) # (None, 10, 8, 8, 128)
    addpool_1 = layers.concatenate([pool_1, pool_1])
    general_utils.print_int_shape(addpool_1) # (None, 10, 8, 8, 128)
    add_2 = layers.add([addpool_1, conv_4])
    general_utils.print_int_shape(add_2) # (None, 10, 8, 8, 128)

    pool_2 = layers.MaxPooling3D((2,2,2))(add_2)
    general_utils.print_int_shape(pool_2) # (None, 5, 4, 4, 128)
    ...
    general_utils.print_int_shape(conv_5) # (None, 5, 4, 4, 128)
    ...
    general_utils.print_int_shape(conv_6) # (None, 5, 4, 4, 256)
    addpool_2 = layers.concatenate([pool_2, pool_2])
    general_utils.print_int_shape(addpool_2) # (None, 5, 4, 4, 256)
    add_3 = layers.add([addpool_2, conv_6])
    general_utils.print_int_shape(add_3) # (None, 5, 4, 4, 256)

    pool_3 = layers.MaxPooling3D((5,2,2))(add_3)
    general_utils.print_int_shape(pool_3) # (None, 1, 2, 2, 256)
    ...
    general_utils.print_int_shape(conv_7) # (None, 1, 2, 2, 256)
    ...
    general_utils.print_int_shape(conv_8) # (None, 1, 2, 2, 512)
    addpool_3 = layers.concatenate([pool_3, pool_3])
    general_utils.print_int_shape(addpool_3) # (None, 1, 2, 2, 512)
    add_4 = layers.add([addpool_3, conv_8])
    general_utils.print_int_shape(add_4) # (None, 1, 2, 2, 512)
    up_1 = layers.UpSampling3D(size=(5,2,2))(add_4)
    general_utils.print_int_shape(up_1) # (None, 5, 4, 4, 512)

    addadd_3 = layers.concatenate([add_3, add_3], axis=-1)
    general_utils.print_int_shape(addadd_3) # (None, 5, 4, 4, 512)
    conc_1 = layers.concatenate([up_1, addadd_3], axis=-1)
    general_utils.print_int_shape(conc_1) # (None, 5, 4, 4, 1024)
    ...
    general_utils.print_int_shape(conv_9) # (None, 5, 4, 4, 256)
    ...
    general_utils.print_int_shape(conv_10) # (None, 5, 4, 4, 512)
    addconv_10 = layers.concatenate([conv_10, conv_10])
    general_utils.print_int_shape(addconv_10) # (None, 5, 4, 4, 1024)
    add_5 = layers.add([conc_1, addconv_10])
    general_utils.print_int_shape(add_5) # (None, 5, 4, 4, 1024)
    up_2 = layers.UpSampling3D(size=(2,2,2))(add_5)
    general_utils.print_int_shape(up_2) # (None, 10, 8, 8, 1024)
    ...
    general_utils.print_int_shape(addadd_2) # (None, 10, 8, 8, 1024)
    conc_2 = layers.concatenate([up_2, addadd_2], axis=-1)
    general_utils.print_int_shape(conc_2) # (None, 10, 8, 8, 2048)
    ...
    general_utils.print_int_shape(conv_11) # (None, 10, 8, 8, 128)
    ...
    general_utils.print_int_shape(conv_12) # (None, 10, 8, 8, 128)
    ...
    general_utils.print_int_shape(addconv_12) # (None, 10, 8, 8, 2048)
    add_6 = layers.add([conc_2, addconv_12])
    general_utils.print_int_shape(add_6) # (None, 10, 8, 8, 2048)
    up_3 = layers.UpSampling3D(size=(3,2,2))(add_6)
    general_utils.print_int_shape(up_3) # (None, 30, 16, 16, 2048)
    ...
    general_utils.print_int_shape(addadd_1) # (None, 30, 16, 16, 2048)
    conc_3 = layers.concatenate([up_3, addadd_1], axis=-1)
    general_utils.print_int_shape(conc_3) # (None, 30, 16, 16, 4096)
    ...
    general_utils.print_int_shape(conv_13) # (None, 30, 16, 16, 64)
    ...
    general_utils.print_int_shape(conv_14) # (None, 30, 16, 16, 64)
    ...
    general_utils.print_int_shape(addconv_14) # (None, 30, 16, 16, 4096)
    add_7 = layers.add([conc_3, addconv_14])
    general_utils.print_int_shape(add_7) # (None, 30, 16, 16, 4096)
    ...
    general_utils.print_int_shape(conv_15) # (None, 30, 16, 16, 4)

    pool_last = layers.MaxPooling3D((constants.NUMBER_OF_IMAGE_PER_SECTION,1,1))(conv_15)
    y = layers.Reshape((constants.getM(),constants.getN(),4))(pool_last)
    general_utils.print_int_shape(y) # (None, 16, 16, 4)
