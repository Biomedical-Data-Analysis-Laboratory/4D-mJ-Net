...
def van_De_Leemput(X, params):
    ...
    conv_1 = layers.Conv3D(32, kernel_size=(constants.NUMBER_OF_IMAGE_PER_SECTION,3,3), padding='same', kernel_regularizer=l1_l2_reg)(input_x)
    conv_1 = layers.LeakyReLU(alpha=0.33)(conv_1)
    conv_1 = layers.BatchNormalization()(conv_1)
    print(K.int_shape(conv_1)) # (None, 30, 16, 16, 32)
    conv_2 = layers.Conv3D(64, kernel_size=(constants.NUMBER_OF_IMAGE_PER_SECTION,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_1)
    ...
    conv_3 = layers.Conv3D(64, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(pool_1)
    conv_3 = layers.LeakyReLU(alpha=0.33)(conv_3)
    conv_3 = layers.BatchNormalization()(conv_3)
    print(K.int_shape(conv_3)) # (None, 1, 8, 8, 64)
    conv_4 = layers.Conv3D(128, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_3)
    ...
    conv_5 = layers.Conv3D(128, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(pool_2)
    conv_5 = layers.LeakyReLU(alpha=0.33)(conv_5)
    conv_5 = layers.BatchNormalization()(conv_5)
    print(K.int_shape(conv_5)) # (None, 1, 4, 4, 128)
    conv_6 = layers.Conv3D(256, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_5)
    ...
    conv_7 = layers.Conv3D(256, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(pool_3)
    ...
    conv_8 = layers.Conv3D(512, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_7)
    ...
    conv_9 = layers.Conv3D(256, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conc_1)
    conv_9 = layers.LeakyReLU(alpha=0.33)(conv_9)
    conv_9 = layers.BatchNormalization()(conv_9)
    print(K.int_shape(conv_9)) # (None, 1, 4, 4, 256)
    conv_10 = layers.Conv3D(512, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_9)
    ...
    conv_11 = layers.Conv3D(128, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conc_2)
    ...
    conv_12 = layers.Conv3D(128, kernel_size=(3,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_11)
    ...
    conv_13 = layers.Conv3D(64, kernel_size=(1,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conc_3)
    ...
    conv_14 = layers.Conv3D(64, kernel_size=(1,3,3), padding='same', kernel_regularizer=l1_l2_reg)(conv_13)
    ...
    conv_15 = layers.Conv3D(1, (1,1,1), activation="sigmoid", padding='same', kernel_regularizer=l1_l2_reg)(add_7)
...
def Ronneberger_UNET(X, params):
    input_x = layers.Input(shape=X.shape[1:], sparse=False)
    print(K.int_shape(input_x)) # (None, 30, 16, 16, 1)
    conv_1 = layers.Conv3D(64, kernel_size=(constants.NUMBER_OF_IMAGE_PER_SECTION,3,3), activation='relu', padding='same')(input_x)
    print(K.int_shape(conv_1)) # (None, 30, 16, 16, 64)
    conv_2 = layers.Conv3D(64, kernel_size=(constants.NUMBER_OF_IMAGE_PER_SECTION,3,3), activation='relu', padding='same')(conv_1)
    print(K.int_shape(conv_2)) # (None, 30, 16, 16, 64)

    pool_1 = layers.MaxPooling3D((constants.NUMBER_OF_IMAGE_PER_SECTION,2,2))(conv_2)
    print(K.int_shape(pool_1)) # (None, 1, 8, 8, 64)
    conv_3 = layers.Conv3D(128, kernel_size=(3,3,3), activation='relu', padding='same')(pool_1)
    print(K.int_shape(conv_3)) # (None, 1, 8, 8, 128)
    conv_4= layers.Conv3D(128, kernel_size=(3,3,3), activation='relu', padding='same')(conv_3)
    print(K.int_shape(conv_4)) # (None, 1, 8, 8, 128)

    pool_2 = layers.MaxPooling3D((1,2,2))(conv_4)
    print(K.int_shape(pool_2)) # (None, 1, 4, 4, 128)
    conv_5 = layers.Conv3D(256, kernel_size=(3,3,3), activation='relu', padding='same')(pool_2)
    print(K.int_shape(conv_5)) # (None, 1, 4, 4, 256)
    conv_6= layers.Conv3D(256, kernel_size=(3,3,3), activation='relu', padding='same')(conv_5)
    print(K.int_shape(conv_6)) # (None, 1, 4, 4, 256)
    pool_3 = layers.MaxPooling3D((1,2,2))(conv_6)
    print(K.int_shape(pool_3)) # (None, 1, 2, 2, 256)

    conv_7 = layers.Conv3D(512, kernel_size=(1,3,3), activation='relu', padding='same')(pool_3)
    print(K.int_shape(conv_7)) # (None, 1, 2, 2, 512)
    conv_8= layers.Conv3D(512, kernel_size=(1,3,3), activation='relu', padding='same')(conv_7)
    print(K.int_shape(conv_8)) # (None, 1, 2, 2, 512)
    pool_4 = layers.MaxPooling3D((1,2,2))(conv_8)
    print(K.int_shape(pool_4)) # (None, 1, 1, 1, 512)

    conv_9 = layers.Conv3D(1024, kernel_size=(3,3,3), activation='relu', padding='same')(pool_4)
    print(K.int_shape(conv_9)) # (None, 1, 1, 1, 1024)
    conv_10 = layers.Conv3D(1024, kernel_size=(3,3,3), activation='relu', padding='same')(conv_9)
    print(K.int_shape(conv_10)) # (None, 1, 1, 1, 1024)

    up_1 = layers.Conv3DTranspose(512, kernel_size=(1,2,2), strides=(1,2,2), activation='relu', padding='same')(conv_10)
    ...
    conv_11 = layers.Conv3D(512, kernel_size=(3,3,3), activation='relu', padding='same')(conc_1)
    print(K.int_shape(conv_11)) # (None, 1, 2, 2, 512)
    conv_12 = layers.Conv3D(256, kernel_size=(3,3,3), activation='relu', padding='same')(conv_11)
    print(K.int_shape(conv_12)) # (None, 1, 2, 2, 256)

    up_2 = layers.Conv3DTranspose(256, kernel_size=(1,2,2), strides=(1,2,2), activation='relu', padding='same')(conv_12)
    ...
    conv_13 = layers.Conv3D(512, kernel_size=(3,3,3), activation='relu', padding='same')(conc_2)
    print(K.int_shape(conv_13)) # (None, 1, 4, 4, 512)
    conv_14 = layers.Conv3D(256, kernel_size=(3,3,3), activation='relu', padding='same')(conv_13)
    print(K.int_shape(conv_14)) # (None, 1, 4, 4, 256)

    up_3 = layers.Conv3DTranspose(128, kernel_size=(1,2,2), strides=(1,2,2), activation='relu', padding='same')(conv_14)
    ...
    conv_15 = layers.Conv3D(256, kernel_size=(3,3,3), activation='relu', padding='same')(conc_3)
    print(K.int_shape(conv_15)) # (None, 1, 8, 8, 256)
    conv_16 = layers.Conv3D(128, kernel_size=(3,3,3), activation='relu', padding='same')(conv_15)
    print(K.int_shape(conv_16)) # (None, 1, 8, 8, 128)

    up_4 = layers.Conv3DTranspose(64, kernel_size=(1,2,2), strides=(1,2,2), activation='relu', padding='same')(conv_16)
    ...
    conv_17 = layers.Conv3D(128, kernel_size=(3,3,3), activation='relu', padding='same')(conc_4)
    print(K.int_shape(conv_17)) # (None, 1, 16, 16, 128)
    conv_18 = layers.Conv3D(64, kernel_size=(3,3,3), activation='relu', padding='same')(conv_17)
    print(K.int_shape(conv_18)) # (None, 1, 16, 16, 64)
    conv_19 = layers.Conv3D(64, kernel_size=(3,3,3), activation='relu', padding='same')(conv_18)
    print(K.int_shape(conv_19)) # (None, 1, 16, 16, 64)

    conv_20 = layers.Conv3D(1, (1,1,1), activation="sigmoid", padding='same')(conv_19)
